<?php
    ...
    $q = [
        ...
        "3" => [
            ...
            Google Ireland Limited, if you’re located in the European Economic Area (EU countries plus Iceland, Liechtenstein, and Norway) or Switzerland <br><br>
            Google LLC, based in the United States, for the rest of the world <br>
            The version of the terms that govern our relationship, which can vary depending on local laws <br>
            Keep in mind that Google services are essentially the same regardless of the affiliate that provides the services or your country association. <br><br>
            
            <br><span class='subtitle'>Determining the country associated with your account</span> <br>
